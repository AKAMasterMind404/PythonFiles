...
# A string is said to be using strong language if it contains at least K consecutive
# characters '*'.
#
...
#
# Output
# Print a single line containing the string "YES" if the string contains strong language
